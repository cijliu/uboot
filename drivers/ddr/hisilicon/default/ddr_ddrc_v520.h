 ...
 * ddr_ddrc_v520.h
 *
 * Copyright (c) 2009-2017, HiSilicon Technologies Co., Ltd.
 * All rights reserved.
 *
...
#define DDR_RNKVOL_SET_FUNC(cfg) \
	do { \
			if (1 == cfg->rank_idx) { \
				REG_WRITE(REG_READ(cfg->cur_dmc + DDR_DMC_CFG_RNKVOL(0)) & (~DMC_RNKVOL_MEM_ROW_MASK), cfg->cur_dmc + DDR_DMC_CFG_RNKVOL(0)); \
			} \
	} while (0)
