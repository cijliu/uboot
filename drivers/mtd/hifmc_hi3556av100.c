...
static void hi3556av100_nand_io_config(void)
{
...
void hifmc100_nand_controller_enable(int enable)
{
    ...
    hi3556av100_nand_io_config();
}

/* configure io for spi controller, just for hi3556av100 */
static void hi3556av100_spi_io_config(void)
{
