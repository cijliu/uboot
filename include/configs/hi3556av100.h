 ...
 *
 * Configuration for Hifonev500 Parts were derived from other ARM
 * configurations.
 *
 * SPDX-License-Identifier: GPL-2.0+
 */

#ifndef __HI3556AV100_H
#define __HI3556AV100_H
...
#define CONFIG_SYS_TEXT_BASE        0x20800000
#define CONFIG_SYS_TEXT_BASE_ORI        0x20700000

#define CONFIG_NR_DRAM_BANKS        1

#define PHYS_SDRAM_1            0x20000000
#define PHYS_SDRAM_1_SIZE       0x20000000/*0xE0000000*/

#define CONFIG_SYS_SDRAM_BASE       PHYS_SDRAM_1


#define CONFIG_SYS_INIT_SP_ADDR     0x04204000
...
#define CONFIG_HIGMAC_PHY0_INTERFACE_MODE   2 /* rgmii 2, rmii 1*/
...
#define CONFIG_BOOTARGS "mem=128M console=ttyAMA0,115200n8"
#define CONFIG_BOOTCOMMAND "bootm 0x22000000 0x23000000"
...
#define CONFIG_PRODUCTNAME "hi3556av100"
...
/* the macro for pmu by i2c*/
#define I2C_PMU_ENABLE

#endif /* __HI3556AV100_H */
