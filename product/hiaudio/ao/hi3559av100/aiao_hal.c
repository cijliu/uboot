...
static  HI_UL         u32AioBase;
static  HI_UL         u32CrgBase;
void *g_acodec_ctrl0_reg = NULL; 
void *g_acodec_fast_reg = NULL;


#define AIAO_HAL_WRITE_REG(u32Offset, value) \
        (*(volatile HI_U32*)((HI_UL)u32AioBase + (HI_U32)u32Offset) = (value))

#define AIAO_HAL_READ_REG(u32Offset) \
        (*(volatile HI_U32*)((HI_UL)u32AioBase + (HI_U32)u32Offset))

#define AIAO_HAL_WRITE_CRG_REG(u32RegAddr, value) \
        (*(volatile HI_U32*)((HI_UL)u32CrgBase + (HI_U32)(u32RegAddr - CRG_REGS_ADDR)) = (value))

#define AIAO_HAL_READ_CRG_REG(u32RegAddr) \
        (*(volatile HI_U32*)((HI_UL)u32CrgBase + (HI_U32)(u32RegAddr - CRG_REGS_ADDR)))        

HI_U32 AIAO_HAL_ReadReg(HI_U32 u32Offset)
{
    return (*(volatile HI_U32*)((HI_UL)u32AioBase + (HI_U32)u32Offset));
}

HI_VOID AIAO_HAL_WriteReg(HI_U32 u32Offset, HI_U32 u32Value)
{
    *(volatile HI_U32*)((HI_UL)(u32AioBase) + (HI_U32)(u32Offset)) = u32Value;
}
...
HI_S32 SYS_HAL_AioClkSel(HI_VOID)
{
    ...
    acodec_Ctr0setbit(u32Tmp, 31, IO_ADDRESS(CRG_PERCTL66_ADDR));
    acodec_Ctr0setbit(u32Tmp, 30, IO_ADDRESS(CRG_PERCTL66_ADDR));
...
HI_S32 SYS_HAL_AioClkEn(HI_BOOL bClkEn)
{
    ...
    acodec_Ctr0setbit(u32Tmp, 29, IO_ADDRESS(CRG_PERCTL66_ADDR));
...
HI_S32 SYS_HAL_AioResetSel(HI_BOOL bReset)
{
    ...
    acodec_Ctr0setbit(u32Tmp, 28, IO_ADDRESS(CRG_PERCTL66_ADDR));
