...
int REG_HDMI_CRG_hdmitx_pxl_cken_Get(HI_VOID)
{
    ...
    pu32RegAddr = (HI_U32*)&(s_pstRegCrg->PERI_CRG68.u32);
    o_peri_crg68.u32 = HDMITXRegRead(pu32RegAddr);
    return o_peri_crg68.bits.hdmitx_pxl_cken;
}
...
int REG_HDMI_CRG_phy_tmds_cken_Set(unsigned int uphy_tmds_cken)
{
    ...
    o_peri_crg70.bits.phy_tmds_cken = uphy_tmds_cken;
...
int REG_HDMI_CRG_phy_tmds_cken_Get(HI_VOID)
{
    ...
    pu32RegAddr = (HI_U32*)&(s_pstRegCrg->PERI_CRG70.u32);
    o_peri_crg70.u32 = HDMITXRegRead(pu32RegAddr);
    return o_peri_crg70.bits.phy_tmds_cken;
}
...
int REG_HDMI_CRG_phy_modclk_cken_Set(unsigned int uphy_modclk_cken)
{
    ...
    o_peri_crg70.u32 = HDMITXRegRead(pu32RegAddr);
    o_peri_crg70.bits.phy_modclk_cken = uphy_modclk_cken;
    HDMITXRegWrite(pu32RegAddr, o_peri_crg70.u32);
...
int REG_HDMI_CRG_phy_modclk_cken_Get(HI_VOID)
{
    ...
    pu32RegAddr = (HI_U32*)&(s_pstRegCrg->PERI_CRG70.u32);
    o_peri_crg70.u32 = HDMITXRegRead(pu32RegAddr);
    return o_peri_crg70.bits.phy_modclk_cken;
}
...
int REG_HDMI_CRG_ac_ctrl_vpxl_cken_Set(unsigned int uac_ctrl_vpxl_cken)
{
    ...
    o_peri_crg70.u32 = HDMITXRegRead(pu32RegAddr);
    o_peri_crg70.bits.ac_ctrl_vpxl_cken = uac_ctrl_vpxl_cken;
    HDMITXRegWrite(pu32RegAddr, o_peri_crg70.u32);
...
int REG_HDMI_CRG_ac_ctrl_vpxl_cken_Get(HI_VOID)
{
    ...
    pu32RegAddr = (HI_U32*)&(s_pstRegCrg->PERI_CRG70.u32);
    o_peri_crg70.u32 = HDMITXRegRead(pu32RegAddr);
    return o_peri_crg70.bits.ac_ctrl_vpxl_cken;
}
...
int REG_HDMI_CRG_hdmitxphy_clk_pctrl_Set(unsigned int uhdmitxphy_clk_pctrl)
{
    ...
    o_peri_crg70.u32 = HDMITXRegRead(pu32RegAddr);
    o_peri_crg70.bits.hdmitxphy_clk_pctrl = uhdmitxphy_clk_pctrl;
    HDMITXRegWrite(pu32RegAddr, o_peri_crg70.u32);
...
int REG_HDMI_CRG_hdmitxphy_clk_pctrl_Get(HI_VOID)
{
    ...
    pu32RegAddr = (HI_U32*)&(s_pstRegCrg->PERI_CRG70.u32);
    o_peri_crg70.u32 = HDMITXRegRead(pu32RegAddr);
    return o_peri_crg70.bits.hdmitxphy_clk_pctrl;
}
