...
typedef union
{
    ...
    struct
    {
        unsigned int    reg_h_sync            : 16  ; /* [15..0]  */
        unsigned int    reg_h_front           : 16  ; /* [31..16]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    reg_h_active          : 16  ; /* [15..0]  */
        unsigned int    reg_h_back            : 16  ; /* [31..16]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    reg_v_sync            : 16  ; /* [15..0]  */
        unsigned int    reg_v_front           : 16  ; /* [31..16]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    reg_v_active          : 16  ; /* [15..0]  */
        unsigned int    reg_v_back            : 16  ; /* [31..16]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        unsigned int    colorbar_width        : 16  ; /* [15..0]  */
        unsigned int    square_height         : 16  ; /* [31..16]  */
    } bits;
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    hsync_total_cnt  : 14  ; /* [29..16]  */
...
typedef union
{
    ...
    struct
    {
        unsigned int    cap_pixel_position    : 14  ; /* [13..0]  */
        unsigned int    reserved_0            : 2   ; /* [15..14]  */
        unsigned int    cap_line_position     : 14  ; /* [29..16]  */
        unsigned int    reserved_1            : 2   ; /* [31..30]  */
    } bits;
...
/* Define the union U_TX_PACK_FIFO_CTRL,ATTR:,ADDR:a00,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_TX_PACK_FIFO_ST,ATTR:,ADDR:a04,INIT:00007F14,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_TX_PACK_FIFO_ST,ATTR:,ADDR:a08,INIT:000003FF,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
    {
        unsigned int    pclk2tclk_stable     : 18  ; /* [17:0] */
...
/* Define the union U_TCLK_LOWER_THRESHOLD,ATTR:,ADDR:a0c,INIT:000003F8,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_TCLK_UPPER_THRESHOLD,ATTR:,ADDR:a10,INIT:00000408,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
typedef struct
{
	...
	unsigned int                      Reserved_3[10]         ; /* 890-8B4 */
    ...
    unsigned int                      Reserved_7[5]          ; /* 920-930 */
    ...
    unsigned int                      Reserved_8[3]          ; /* 974-97c */
    volatile U_VIDEO_DWSM_CTRL        VIDEO_DWSM_CTRL        ; /* 980 */
	unsigned int                      Reserved_9[2]          ; /* 984-988 */
	...
	unsigned int                      Reserved_10[3]         ; /* 99C-9A4 */
    volatile U_VIDEO_DMUX_CTRL        VIDEO_DMUX_CTRL        ; /* 9A8 */
    volatile U_VIDEO_DMUX_CTRL        Reserved_11[21]        ; /* 9AC-9FC */
    volatile U_TX_PACK_FIFO_CTRL      TX_PACK_FIFO_CTRL      ; /* A00 */
    volatile U_TX_PACK_FIFO_ST        TX_PACK_FIFO_ST        ; /* A04 */
    volatile U_PCLK_REFER_CNT         PCLK_REFER_CNT         ; /* A08 */
    volatile U_TCLK_LOWER_THRESHOLD   TCLK_LOWER_THRESHOLD   ; /* A0c */
    volatile U_TCLK_UPPER_THRESHOLD   TCLK_UPPER_THRESHOLD   ; /* A10 */
