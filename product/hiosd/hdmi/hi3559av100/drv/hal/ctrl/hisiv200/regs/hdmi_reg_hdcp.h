...
/* Define the union U_HDCP1X_MEM_CTRL,ATTR:,ADDR:2000,INIT:00000000,MASK:7ff*/
typedef union
{
...
/* Define the union U_HDCP1X_KEY_AKSV0,ATTR:,ADDR:2004,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_KEY_AKSV1,ATTR:,ADDR:2008,INIT:00000000,MASK:ff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP_MUTE_CTRL,ATTR:,ADDR:200C,INIT:00000000,MASK:3f*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP_FUN_SEL,ATTR:,ADDR:2014,INIT:00000001,MASK:1*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_SEC_CFG,ATTR:,ADDR:201C,INIT:00000000,MASK:3*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_ENG_CTRL,ATTR:,ADDR:2020,INIT:00000FE1,MASK:fff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_ENG_STATUS,ATTR:,ADDR:2024,INIT:00000000,MASK:1ff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_ENG_BKSV0,ATTR:,ADDR:2028,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_ENG_BKSV1,ATTR:,ADDR:202C,INIT:00000000,MASK:ff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_ENG_GEN_AN0,ATTR:,ADDR:2030,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_ENG_GEN_AN1,ATTR:,ADDR:2034,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_ENG_FUN_AN0,ATTR:,ADDR:2038,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_ENG_FUN_AN1,ATTR:,ADDR:203C,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_ENG_RI,ATTR:,ADDR:2040,INIT:00000000,MASK:ffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_RPT_BSTATUS,ATTR:,ADDR:2058,INIT:00000000,MASK:ffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_RPT_KLIST,ATTR:,ADDR:205C,INIT:00000000,MASK:ff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_SHA_CTRL,ATTR:,ADDR:2060,INIT:00000000,MASK:7*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_SHA_V0,ATTR:,ADDR:2064,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_SHA_V1,ATTR:,ADDR:2068,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_SHA_V2,ATTR:,ADDR:206C,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_SHA_V3,ATTR:,ADDR:2070,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_SHA_V4,ATTR:,ADDR:2074,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_CHK_CTRL,ATTR:,ADDR:2080,INIT:00000012,MASK:1f*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_CHK_START,ATTR:,ADDR:2084,INIT:107E007F,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_CHK_ERR,ATTR:,ADDR:2088,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_CHK_STATE,ATTR:,ADDR:208C,INIT:00000000,MASK:f*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP2X_ENC_CTRL,ATTR:,ADDR:20A0,INIT:00000001,MASK:1*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP2X_DBG_CTRL,ATTR:,ADDR:20A4,INIT:00000000,MASK:1*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP2X_ENC_STATE,ATTR:,ADDR:20B4,INIT:00000000,MASK:1*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_RPT_V0,ATTR:,ADDR:20E0,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_RPT_V1,ATTR:,ADDR:20E4,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_RPT_V2,ATTR:,ADDR:20E8,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_RPT_V3,ATTR:,ADDR:20EC,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_RPT_V4,ATTR:,ADDR:20F0,INIT:00000000,MASK:ffffffff*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_SHA_CHECK,ATTR:,ADDR:20F4,INIT:00000000,MASK:1*/
typedef union
{
    /* Define the struct bits */
    struct
...
/* Define the union U_HDCP1X_SHA_RESULT,ATTR:,ADDR:20F8,INIT:00000000,MASK:3*/
typedef union
{
    /* Define the struct bits */
    struct
