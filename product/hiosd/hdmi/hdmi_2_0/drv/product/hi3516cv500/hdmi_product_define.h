...
#define HDMI_TX_BASE_ADDR_AIDEO     0x20800
...
#define HDMI_COPY_TO_USER                   osal_copy_to_user
...
#define HI_TRACE_HDMI(level, fmt, ...)  HI_TRACE(level, HI_ID_HDMI,"[%s][%d]"fmt,__FUNCTION__, __LINE__,##__VA_ARGS__);
