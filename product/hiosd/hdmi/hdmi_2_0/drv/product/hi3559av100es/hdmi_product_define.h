...
#define HDMI_CHIP_HI3559AV100ES     0x3559a000
...
#define HDMI_WAIT_EVENT_TIMEOUT_INTERRUPT(a, callback, param, timeout)     osal_wait_event_timeout_interruptible(&(a), (callback), (HI_VOID *)param, timeout)
#define HDMI_WAIT_EVENT_INTERRUPT(a, callback, param)                      osal_wait_event_interruptible(&(a), (callback), (HI_VOID *)param)
#define HDMI_VA_START(a, b)                 osal_va_start((a), (b))
#define HDMI_VA_END(a)                      osal_va_end(a)
#define HDMI_VA_LIST                        osal_va_list
#define HDMI_SPIN_S				            osal_spinlock_t
...
#define HI_HDMI_MODULE_Register(u32ModuleID, pszModuleName, pData)
#define HI_HDMI_DEV_Register(HdmiDev)
#define HI_HDMI_DEV_UnRegister(HdmiDev)
#define HI_HDMI_UserCopy(file, cmd, arg, HdmiIoctl)
