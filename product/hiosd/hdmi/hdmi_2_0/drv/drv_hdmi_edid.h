...
{
    HI_BOOL    bDSC_1p2         ;
    HI_BOOL    bDSC_Native_420  ;
    HI_BOOL    bDSC_All_bpp     ;
    HI_BOOL    bDSC_10bpc       ;
    HI_BOOL    bDSC_12bpc       ;
    HI_BOOL    bDSC_16bpc       ;
    HI_U8      u8DSC_MaxSlices  ;
    HI_U8      u8DSCMaxFrlRate  ;
    HI_U8      u8DSC_TotalChunkKBytes;

} HDMI_EDID_DSC_INFO_S;
...
typedef struct hiHDMI_EDID_DOLBY_CAPS_VER_1_S
{
    ...
    HI_BOOL     bColorimetry;           /* this bit is valid only u8VSVDBVersion = 1. 0: Dolby Vision HDMI sink's colorimetry is close to Rec.709, 1: EDR HDMI sink's colorimetry is close to P3, if Byte[9] to Byte[14] are present, ignores this bit. */
...
typedef struct hiHDMI_EDID_DOLBY_CAP_S
{
    ...
    HDMI_EDID_DOLBY_CAPS_U unOtherCaps; /* other caps in Dolby VSVDB. distinction between V0(u8VSVDBVersion=0) and V1(u8VSVDBVersion=1).*/
...
typedef struct hiHDMI_EDID_EOTF_S
{
    ...
    HI_BOOL bEotfHLG;               /* Hybrid Log-Gamma */
...
{
    HI_U8      u8MaxImageWidth;               /**<The disp image max width  (0~255)cm*/
    HI_U8      u8MaxImageHeight;              /**<The disp image max height (0~255)cm*/
...
typedef struct
{
    ...
    HI_BOOL                         bSupportAudioSpeaker[HDMI_EDID_MAX_AUDIO_SPEAKER_COUNT];
    ...
    HI_U8                           u8VRRMIN;
    HI_U16                          u16VRRMAX;
    HDMI_EDID_DSC_INFO_S            stDscInfo;
