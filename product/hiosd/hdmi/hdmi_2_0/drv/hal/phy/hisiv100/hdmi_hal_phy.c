...
#if (defined(CHIP_TYPE_hi3516cv500))
//#define PHY_SPEC_DEBUG
#endif
...
do{\
    if(HI_FAILURE == ret) {\
        HDMI_ERR("ret is failure\n");\
        return HI_FAILURE;}\
}while(0)

#define PHY_INIT_CHK do{\
    if(HI_TRUE != s_stHDMIPhyInfo.bInit)\
    {HDMI_ERR("phy intf module didn't init!\n");\
    return HI_FAILURE;}\
}while(0)
...
#elif defined(CHIP_TYPE_hi3531dv100)
static PHY_HWSPEC_S s_stPhyHWSpecTab[] =
{
/* support 4inch and 5inch */
/****|-TmdsclkRange---||---DeIMain----||-iMain/0.5mA--||---DeIPre---- ||-iPre/0.25mA--||----------------DeRPre/Ohm------------------------||----------------RPre/Ohm-------------------------||------------------------RTerm--------------------------------------------------------------------------------------|**
*****|   Min  Max     ||clk d0  d1  d2||clk d0  d1  d2||clk d0  d1  d2|| clk d0  d1 d2||     clk       d0            d1          d2       ||     clk       d0            d1          d2      ||  clk_rterm_mode    clk_rterm    d0_rterm_mode   d0_rterm    d1_rterm_mode    d1_rterm     clk_rterm_mode  d2_rterm|*/
    {{ 25000, 100000}, { 0,  0,  0,  0, 25, 25, 25, 25,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20}},
    {{100001, 165000}, { 0,  0,  0,  0, 28, 40, 40, 40, 24, 24, 24, 24, 24, 24, 24, 24, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x60, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60}},
    {{165001, 340000}, { 0,  4,  4,  8, 21, 40, 40, 40, 24, 24, 24, 24, 24, 24, 24, 24, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x03, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60}},
    {{340001, 600000}, { 5,  5,  5,  5, 29, 43, 43, 43,  0, 25, 25, 25, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_SOURCE, 0x00, PHY_RTERM_MODE_LOAD  , 0x80, PHY_RTERM_MODE_LOAD  , 0x80, PHY_RTERM_MODE_LOAD  , 0x80}},
};
...
/****|-TmdsclkRange---||---DeIMain----||-iMain/0.5mA--||---DeIPre---- ||-iPre/0.25mA--||----------------DeRPre/Ohm------------------------||----------------RPre/Ohm-------------------------||------------------------RTerm--------------------------------------------------------------------------------------|**
*****|   Min  Max     ||clk d0  d1  d2||clk d0  d1  d2||clk d0  d1  d2|| clk d0  d1 d2||     clk       d0            d1          d2       ||     clk       d0            d1          d2      ||  clk_rterm_mode    clk_rterm    d0_rterm_mode   d0_rterm    d1_rterm_mode    d1_rterm     clk_rterm_mode  d2_rterm|*/
    {{ 25000, 100000}, { 0,  0,  0,  0, 25, 25, 25, 27,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD  , 0x20, PHY_RTERM_MODE_LOAD,   0x20, PHY_RTERM_MODE_LOAD,   0x20}},
    {{100001, 165000}, { 0,  0,  0,  0, 22, 37, 37, 39, 24, 24, 24, 24, 24, 24, 24, 24, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x63, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60}},
    {{165001, 340000}, { 0,  4,  4,  8, 21, 38, 38, 40, 24, 24, 24, 24, 24, 24, 24, 24, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x03, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60}},
...
/****|-TmdsclkRange---||---DeIMain----||-iMain/0.5mA--||---DeIPre---- ||-iPre/0.25mA--||----------------DeRPre/Ohm------------------------||----------------RPre/Ohm-------------------------||------------------------RTerm--------------------------------------------------------------------------------------|**
*****|   Min  Max     ||clk d0  d1  d2||clk d0  d1  d2||clk d0  d1  d2|| clk d0  d1 d2||     clk       d0            d1          d2       ||     clk       d0            d1          d2      ||  clk_rterm_mode    clk_rterm    d0_rterm_mode   d0_rterm    d1_rterm_mode    d1_rterm     clk_rterm_mode  d2_rterm|*/
    {{ 25000, 100000}, { 0,  0,  0,  0, 21, 32, 32, 32, 24, 24, 24, 24, 24, 24, 24, 24, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x63, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60}},
    {{100001, 165000}, { 0,  0,  0,  0, 20, 33, 33, 33, 24, 24, 24, 24, 24, 24, 24, 24, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x63, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60}},
    {{165001, 340000}, { 0,  2,  2,  2, 20, 34, 34, 34, 24, 24, 24, 24, 24, 24, 24, 24, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x03, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60, PHY_RTERM_MODE_SOURCE, 0x60}},
    {{340001, 600000}, { 5,  0,  0,  0, 29, 43, 43, 43,  0,  0,  0,  0, 20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_SOURCE, 0x00, PHY_RTERM_MODE_LOAD  , 0x80, PHY_RTERM_MODE_LOAD  , 0x80, PHY_RTERM_MODE_LOAD  , 0x80}},
};
...
/****|-TmdsclkRange---||---DeIMain----||-iMain/0.5mA--||---DeIPre---- ||-iPre/0.25mA--||----------------DeRPre/Ohm------------------------||----------------RPre/Ohm-------------------------||------------------------RTerm-----------------------------------------------------------------------------------------------------|**
*****|   Min  Max     ||clk d0  d1  d2||clk d0  d1  d2||clk d0  d1  d2|| clk d0  d1 d2||     clk       d0            d1          d2       ||     clk       d0            d1          d2      ||  clk_rterm_mode       clk_rterm    d0_rterm_mode       d0_rterm    d1_rterm_mode        d1_rterm     clk_rterm_mode      d2_rterm|*/
    {{ 25000, 100000}, { 0,  0,  0,  0, 22, 30, 30, 30,  0,  0,  0,  0,  20, 20, 20, 20, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x00, PHY_RTERM_MODE_DOUBLEDIFF, 0x20, PHY_RTERM_MODE_DOUBLEDIFF, 0x20, PHY_RTERM_MODE_DOUBLEDIFF, 0x20}},
    {{100001, 165000}, { 0,  0,  0,  0, 18, 26, 26, 27,  0,  0,  0,  0,  24, 24, 24, 24, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_LOAD  , 0x03, PHY_RTERM_MODE_DOUBLEDIFF, 0x60, PHY_RTERM_MODE_DOUBLEDIFF, 0x60, PHY_RTERM_MODE_DOUBLEDIFF, 0x60}},
    {{165001, 340000}, { 0,  0,  0,  0, 18, 29, 29, 29,  0, 32, 32, 32,  20, 32, 32, 32, PHY_RPRE_83, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RTERM_MODE_LOAD  , 0x03, PHY_RTERM_MODE_DOUBLEDIFF, 0x60, PHY_RTERM_MODE_DOUBLEDIFF, 0x60, PHY_RTERM_MODE_DOUBLEDIFF, 0x60}},
    {{340001, 600000}, { 5,  5,  5,  5, 29, 43, 43, 43,  0, 25, 25, 25,  20, 20, 20, 20, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_50, PHY_RPRE_83, PHY_RPRE_83, PHY_RPRE_83, PHY_RTERM_MODE_SOURCE, 0x00, PHY_RTERM_MODE_LOAD      , 0x80, PHY_RTERM_MODE_LOAD      , 0x80, PHY_RTERM_MODE_LOAD      , 0x80}},
};
#endif
#else
...
/**    pixel-range       deepcolor          pixDiv BypDiv TmdsNxDiv     loopdiv               clkRatio             phyDivMode**/
    {{ 25000,  42500}, HDMI_DEEP_COLOR_24BIT,   16,    10,      8,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_8X},
    {{ 42501,  85000}, HDMI_DEEP_COLOR_24BIT,    8,    10,      4,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_4X},
    {{ 85001, 170000}, HDMI_DEEP_COLOR_24BIT,    4,    10,      2,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_2X},
    {{170001, 340000}, HDMI_DEEP_COLOR_24BIT,    2,    10,      1,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_1X},

    {{ 20000,  34000}, HDMI_DEEP_COLOR_30BIT,   16,     8,      8,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_8X},
    {{ 34001,  42500}, HDMI_DEEP_COLOR_30BIT,   16,    16,      4,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_4X},
    {{ 42501,  68000}, HDMI_DEEP_COLOR_30BIT,    8,     8,      4,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_4X},
    {{ 68001,  85000}, HDMI_DEEP_COLOR_30BIT,    8,    16,      2,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_2X},
    {{ 85001, 136000}, HDMI_DEEP_COLOR_30BIT,    4,     8,      2,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_2X},
    {{136001, 170000}, HDMI_DEEP_COLOR_30BIT,    4,    16,      1,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_1X},
    {{170001, 272000}, HDMI_DEEP_COLOR_30BIT,    2,     8,      1,   PHY_LOOP_DIV_CFG_25   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_1X},

    {{ 16000,  28000}, HDMI_DEEP_COLOR_36BIT,   16,     6,      8,   PHY_LOOP_DIV_CFG_22   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_8X},
    {{ 28001,  42000}, HDMI_DEEP_COLOR_36BIT,   16,    12,      4,   PHY_LOOP_DIV_CFG_22   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_4X},
    {{ 42001,  42500}, HDMI_DEEP_COLOR_36BIT,   16,     6,      4,   PHY_LOOP_DIV_CFG_22   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_4X},
    {{ 42501,  56000}, HDMI_DEEP_COLOR_36BIT,    8,     6,      4,   PHY_LOOP_DIV_CFG_22   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_4X},
    {{ 56001,  85000}, HDMI_DEEP_COLOR_36BIT,    8,    12,      2,   PHY_LOOP_DIV_CFG_22   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_2X},
    {{ 85001, 113000}, HDMI_DEEP_COLOR_36BIT,    4,     6,      2,   PHY_LOOP_DIV_CFG_22   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_2X},
    {{113001, 170000}, HDMI_DEEP_COLOR_36BIT,    4,    12,      1,   PHY_LOOP_DIV_CFG_22   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_1X},
    {{170001, 226000}, HDMI_DEEP_COLOR_36BIT,    2,     6,      1,   PHY_LOOP_DIV_CFG_22   ,  PHY_CLK_RATIO_1_10, INTERPOLATION_MODE_1X},
};
#else
static PHY_DIV_CFG_S s_stPhyDivCfgTab[] =
{
...
HI_S32 HAL_HDMI_PhySpecSet(HDMI_PHY_HWSPEC_CFG_S * pstHdmiSpecCfg)
{
    ...
    if ((pstHdmiSpecCfg->u32TmdsClk >= 25000) && (pstHdmiSpecCfg->u32TmdsClk <= 100000) )
    {
        HDMIRegWriteU32(0x11400068, 0x00861865);
        HDMIRegWriteU32(0x1140006c, 0x18180000);
        HDMIRegWriteU32(0x11400070, 0x00000618);
        HDMIRegWriteU32(0x11400074, 0x0001B6C0);
        HDMIRegWriteU32(0x11400078, 0x20202000);

        u32Tmp = HDMIRegReadU32(0x11400064);
        u32Tmp |= 0xfd << 11;
        HDMIRegWriteU32(0x11400064, u32Tmp);


    }
    else if ((pstHdmiSpecCfg->u32TmdsClk >= 100001) && (pstHdmiSpecCfg->u32TmdsClk <= 165000) )
    {
        HDMIRegWriteU32(0x11400068, 0x00C71C65);
        HDMIRegWriteU32(0x1140006c, 0x18600000);
        HDMIRegWriteU32(0x11400070, 0x00000618);
        HDMIRegWriteU32(0x11400074, 0x0001B780);
        HDMIRegWriteU32(0x11400078, 0x20202000);
    ...
    else if ((pstHdmiSpecCfg->u32TmdsClk >= 165001) && (pstHdmiSpecCfg->u32TmdsClk <= 340000) )
    {
        HDMIRegWriteU32(0x11400068, 0x00C71C65);
        HDMIRegWriteU32(0x1140006c, 0x18600000);
        HDMIRegWriteU32(0x11400070, 0x00000618);
        HDMIRegWriteU32(0x11400074, 0x0001B6C0);
        HDMIRegWriteU32(0x11400078, 0x60606000);
