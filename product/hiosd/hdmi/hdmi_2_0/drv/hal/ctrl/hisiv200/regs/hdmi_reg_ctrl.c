...
int HDMI_TX_S_tx_ctrl_reg_REGS_TYPE_Init(HI_CHAR *pcAddr)
{
    ...
    goptx_ctrl_regAllReg = (volatile S_tx_ctrl_reg_REGS_TYPE *)(pcAddr);
...
//******************************************************************************
//  Function    : HDMI_TX_CHANNEL_reg_vid_bypass_selSet
//  Description : Set the value of the member TX_CHANNEL_SEL.reg_vid_bypass_sel
//  Input       : unsigned int ureg_vid_bypass_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_CHANNEL_reg_vid_bypass_selSet(unsigned int ureg_vid_bypass_sel)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_CHANNEL_SEL o_tx_channel_sel;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_CHANNEL_SEL.u32);
    o_tx_channel_sel.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_channel_sel.bits.reg_vid_bypass_sel = ureg_vid_bypass_sel;
    HDMITXRegWrite(pu32RegAddr, o_tx_channel_sel.u32);
...
//******************************************************************************
//  Function    : HDMI_TX_CHANNEL_SEL_flbk_selSet
//  Description : Set the value of the member TX_CHANNEL_SEL.flbk_sel
//  Input       : unsigned int uflbk_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_CHANNEL_SEL_flbk_selSet(unsigned int uflbk_sel)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_CHANNEL_SEL o_flbk_sel;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_CHANNEL_SEL.u32);
    o_flbk_sel.u32 = HDMITXRegRead(pu32RegAddr);
    o_flbk_sel.bits.flbk_sel = uflbk_sel;
    HDMITXRegWrite(pu32RegAddr, o_flbk_sel.u32);
...
//******************************************************************************
//  Function    : HDMI_TX_PWD_RST_CTRL_frl_soft_arst_reqSet
//  Description : Set the value of the member TX_PWD_RST_CTRL.frl_soft_arst_req
//  Input       : unsigned int ufrl_soft_arst_req: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_PWD_RST_CTRL_frl_soft_arst_reqSet(unsigned int ufrl_soft_arst_req)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    o_tx_pwd_rst_ctrl.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_pwd_rst_ctrl.bits.frl_soft_arst_req = ufrl_soft_arst_req;
    HDMITXRegWrite(pu32RegAddr, o_tx_pwd_rst_ctrl.u32);
...
//******************************************************************************
//  Function    : HDMI_TX_PWD_RST_CTRL_frl_fast_arst_reqSet
//  Description : Set the value of the member TX_PWD_RST_CTRL.frl_fast_arst_req
//  Input       : unsigned int ufrl_fast_arst_req: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_PWD_RST_CTRL_frl_fast_arst_reqSet(unsigned int ufrl_fast_arst_req)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    o_tx_pwd_rst_ctrl.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_pwd_rst_ctrl.bits.frl_fast_arst_req = ufrl_fast_arst_req;
    HDMITXRegWrite(pu32RegAddr, o_tx_pwd_rst_ctrl.u32);
...
//******************************************************************************
//  Function    : HDMI_TX_PWD_RST_CTRL_vidpath_div4_clk_selSet
//  Description : Set the value of the member TX_PWD_RST_CTRL.vidpath_div4_clk_sel
//  Input       : unsigned int uvidpath_div4_clk_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_PWD_RST_CTRL_vidpath_div4_clk_selSet(unsigned int uvidpath_div4_clk_sel)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    o_tx_pwd_rst_ctrl.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_pwd_rst_ctrl.bits.vidpath_div4_clk_sel = uvidpath_div4_clk_sel;
    HDMITXRegWrite(pu32RegAddr, o_tx_pwd_rst_ctrl.u32);
...
//******************************************************************************
//  Function    : HDMI_TX_PWD_RST_CTRL_hdmi_clk_selSet
//  Description : Set the value of the member TX_PWD_RST_CTRL.hdmi_clk_sel
//  Input       : unsigned int uhdmi_clk_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_PWD_RST_CTRL_hdmi_clk_selSet(unsigned int uhdmi_clk_sel)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    o_tx_pwd_rst_ctrl.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_pwd_rst_ctrl.bits.hdmi_clk_sel = uhdmi_clk_sel;
    HDMITXRegWrite(pu32RegAddr, o_tx_pwd_rst_ctrl.u32);
...
//******************************************************************************
//  Function    : HDMI_TX_PWD_RST_CTRL_hdmi_clk_div_selSet
//  Description : Set the value of the member TX_PWD_RST_CTRL.tx_mcu_srst_req
//  Input       : unsigned int uhdmi_clk_div_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_PWD_RST_CTRL_hdmi_clk_div_selSet(unsigned int uhdmi_clk_div_sel)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    o_tx_pwd_rst_ctrl.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_pwd_rst_ctrl.bits.hdmi_clk_div_sel = uhdmi_clk_div_sel;
    HDMITXRegWrite(pu32RegAddr, o_tx_pwd_rst_ctrl.u32);
...
//******************************************************************************
//  Function    : HDMI_TX_PWD_RST_CTRL_audpath_acr_clk_selSet
//  Description : Set the value of the member TX_PWD_RST_CTRL.audpath_acr_clk_sel
//  Input       : unsigned int uaudpath_acr_clk_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_PWD_RST_CTRL_audpath_acr_clk_selSet(unsigned int uaudpath_acr_clk_sel)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    o_tx_pwd_rst_ctrl.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_pwd_rst_ctrl.bits.audpath_acr_clk_sel = uaudpath_acr_clk_sel;
    HDMITXRegWrite(pu32RegAddr, o_tx_pwd_rst_ctrl.u32);
...
//******************************************************************************
//  Function    : HDMI_TX_PWD_RST_CTRL_clk_tmds_source_selSet
//  Description : Set the value of the member TX_PWD_RST_CTRL.clk_tmds_source_sel
//  Input       : unsigned int uclk_tmds_source_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_PWD_RST_CTRL_clk_tmds_source_selSet(unsigned int uclk_tmds_source_sel)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    o_tx_pwd_rst_ctrl.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_pwd_rst_ctrl.bits.clk_tmds_source_sel = uclk_tmds_source_sel;
    HDMITXRegWrite(pu32RegAddr, o_tx_pwd_rst_ctrl.u32);
...
//******************************************************************************
//  Function    : HDMI_TX_PWD_RST_CTRL_clk_frl_source_selSet
//  Description : Set the value of the member TX_PWD_RST_CTRL.clk_frl_source_sel
//  Input       : unsigned int uclk_frl_source_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_PWD_RST_CTRL_clk_frl_source_selSet(unsigned int uclk_frl_source_sel)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    o_tx_pwd_rst_ctrl.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_pwd_rst_ctrl.bits.clk_frl_source_sel = uclk_frl_source_sel;
    HDMITXRegWrite(pu32RegAddr, o_tx_pwd_rst_ctrl.u32);
...
int HDMI_TX_CHANNEL_reg_vid_bypass_selGet(void)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_CHANNEL_SEL o_tx_channel_sel;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_CHANNEL_SEL.u32);
    o_tx_channel_sel.u32 = HDMITXRegRead(pu32RegAddr);
    return o_tx_channel_sel.bits.reg_vid_bypass_sel;
}
...
//******************************************************************************
//  Function    : HDMI_TX_PWD_RST_CTRL_vidpath_dout_clk_selSet
//  Description : Set the value of the member TX_PWD_RST_CTRL.vidpath_dout_clk_sel
//  Input       : unsigned int uvidpath_dout_clk_sel: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_TX_PWD_RST_CTRL_vidpath_dout_clk_selSet(unsigned int uvidpath_dout_clk_sel)
{
    HI_U32 *pu32RegAddr = NULL;
    U_TX_PWD_RST_CTRL o_tx_pwd_rst_ctrl;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->TX_PWD_RST_CTRL.u32);
    o_tx_pwd_rst_ctrl.u32 = HDMITXRegRead(pu32RegAddr);
    o_tx_pwd_rst_ctrl.bits.vidpath_dout_clk_sel = uvidpath_dout_clk_sel;
    HDMITXRegWrite(pu32RegAddr, o_tx_pwd_rst_ctrl.u32);
...
//******************************************************************************
//  Function    : HDMI_YUV_RGB_CFG_reg_yuv_rgb_cfgSet
//  Description : Set the value of the member YUV_RGB_CFG.reg_yuv_rgb_cfg
//  Input       : unsigned int ureg_yuv_rgb_cfg: 1 bits
//  Return      : int: 0-Error, 1-Success
//******************************************************************************
int HDMI_YUV_RGB_CFG_reg_yuv_rgb_cfgSet(unsigned int ureg_yuv_rgb_cfg)
{
    HI_U32 *pu32RegAddr = NULL;
    U_YUV_RGB_CFG o_yuv_rgb_cfg;
    pu32RegAddr = (HI_U32*)&(goptx_ctrl_regAllReg->YUV_RGB_CFG.u32);
    o_yuv_rgb_cfg.u32 = HDMITXRegRead(pu32RegAddr);
    o_yuv_rgb_cfg.bits.reg_yuv_rgb_cfg = ureg_yuv_rgb_cfg;
    HDMITXRegWrite(pu32RegAddr, o_yuv_rgb_cfg.u32);
...
unsigned int HDMI_TX_CTRL_read(unsigned int utx_crl_addr)
{
    HI_CHAR *pcAddr   = HI_NULL;
    HI_U32  u32RegVal = 0;

    if (HI_NULL != goptx_ctrl_regAllReg)
    {
        pcAddr = (HI_CHAR *)goptx_ctrl_regAllReg + utx_crl_addr;
        u32RegVal = HDMITXRegRead((HI_U32 *)pcAddr);
    }

    return u32RegVal;
}

int HDMI_TX_CTRL_write(unsigned int utx_crl_addr, unsigned int uVal)
{
    HI_CHAR *pcAddr = HI_NULL;
    ...
    {
        pcAddr = (HI_CHAR *)goptx_ctrl_regAllReg + utx_crl_addr;
        HDMITXRegWrite((HI_U32 *)pcAddr, uVal);
    }
