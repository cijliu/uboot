...
/* Define the union U_TX_CHANNEL_SEL */
/* Define the union U_TX_CHANNEL_SEL,ATTR:,ADDR:00,INIT:00000004,MASK:ff*/
typedef union
{
...
/* Define the union U_YUV_RGB_CFG */
/* Define the union U_YUV_RGB_CFG,ATTR:,ADDR:04,INIT:00000000,MASK:ff*/
typedef union
{
    /* Define the struct bits */
    struct
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int    scdc_ddcm_speed : 9   ; /* [30:22] */
...
typedef struct
{
    volatile U_TX_CHANNEL_SEL     TX_CHANNEL_SEL     ; /* 00 */
    volatile U_YUV_RGB_CFG        YUV_RGB_CFG        ; /* 04 */
