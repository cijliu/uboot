...
#define CEC_PING_WAIT_ACK   0 // no ACK, no NAK, but not timeout
#define CEC_PING_ACK        1
#define CEC_PING_NAK        2
#define CEC_PING_TIMEOUT    3
...
typedef struct
{
    ...
    CEC_PROCESS_E       enPingProcess;
    CEC_LOGICALADD_E    enPingAddrSequence[CEC_LOGICALADD_BUTT];
    HI_U8               u8PingTotalCnt;
    HI_U8               u8PingIndex;
    HI_BOOL             bIsTuner;//false:playback  true:tuner
    HI_U64              u64MachStamp;
    CEC_MACH_STATUS_E   enMachStatus;
    HI_U64              u64StopStamp;
