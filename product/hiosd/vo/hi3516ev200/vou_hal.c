...
{
    hi_reg_write32(data_mode << 8, 0x7 << 8, IO_ADDRESS(MISC_CTL18_ADDR));
...
hi_bool hal_disp_set_intf_enable(hal_disp_outputchannel chan, hi_bool intf)
{
    ...
    switch (chan) {
        case HAL_DISP_CHANNEL_DHD0: {
            ...
            DHD0_CTRL.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
            DHD0_CTRL.bits.intf_en = intf;
            hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, DHD0_CTRL.u32);
            break;
        }
...
hi_bool hal_disp_set_lcd_serial_perd(hi_u32 serial_perd)
{
    ...
    INTF_LCD_CTRL.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);

    INTF_LCD_CTRL.bits.lcd_serial_perd = serial_perd;

    hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, INTF_LCD_CTRL.u32);
    return HI_TRUE;
}
...
hi_bool hal_disp_set_intf_ctrl(hal_disp_intf intf, hi_u32 *ctrl_info)
{
    ...
    if ((intf == VO_INTF_BT1120) || (intf == VO_INTF_BT656)) {
        ...
        INTF_BT_CTRL.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
        ...
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, INTF_BT_CTRL.u32);
                             ...
                             hal_disp_syncinfo *sync_info, hal_disp_syncinv *inv)
{
    ...
    switch (chan) {
        case HAL_DISP_CHANNEL_DHD0: {
            ...
            hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, DHD0_HSYNC1.u32);
            ...
            hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, DHD0_HSYNC2.u32);
            ...
            hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, DHD0_VSYNC1.u32);
            ...
            hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, DHD0_VSYNC2.u32);
            ...
            hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, DHD0_VPLUS1.u32);
            ...
            hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, DHD0_VPLUS2.u32);
            ...
            hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, DHD0_PWR.u32);
                             ...
                             hal_disp_clip *clip_data)
{
    ...
    hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, BT_CLIP0_L.u32);
    ...
    hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, BT_CLIP0_H.u32);
...
hi_void hal_disp_set_reg_up(hal_disp_outputchannel chan)
{
    ...
    if (chan >= HAL_DISP_CHANNEL_DHD1) {
        HAL_PRINT("error,hal_disp_set_reg_up select wrong CHANNEL ID\n");
        return;
    }
...
hi_bool hal_video_set_layer_up_mode(hal_disp_layer layer, hi_u32 up_mode)
{
    ...
    switch (layer) {
        case HAL_DISP_LAYER_VHD0: {
            addr_reg = vo_get_abs_addr(layer, (hi_u32) & (g_vo_reg->V0_CTRL.u32));
...
hi_void hal_video_hfir_set_mid_en(hal_disp_layer layer, hi_u32 mid_en)
{
    ...
    if ((layer >= LAYER_VHD_START) && (layer <= LAYER_VHD_END)) {
        ...
        V0_HFIR_CTRL.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
        V0_HFIR_CTRL.bits.mid_en = mid_en;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HFIR_CTRL.u32);
    }
...
hi_void vdp_fdr_vid_set_chm_copy_en(hi_u32 layer, hi_u32 chm_copy_en)
{
    ...
    VID_READ_CTRL.u32 = hal_read_reg((hi_u32 *)(hi_ulong)(&(g_vo_reg->VID_READ_CTRL.u32) + layer * FDR_VID_OFFSET));
    VID_READ_CTRL.bits.chm_copy_en = chm_copy_en;
    hal_write_reg ((hi_u32 *)(hi_ulong)(&(g_vo_reg->VID_READ_CTRL.u32) + layer * FDR_VID_OFFSET), VID_READ_CTRL.u32);
    return;
}
...
hi_bool hal_video_hfir_set_coef(hal_disp_layer layer, hfir_coef *hfir_coef)
{
    ...
    if ((layer >= LAYER_VHD_START) && (layer <= LAYER_VHD_END)) {
        ...
        V0_HFIRCOEF01.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
        V0_HFIRCOEF01.bits.coef0 = hfir_coef->coef0;
        V0_HFIRCOEF01.bits.coef1 = hfir_coef->coef1;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HFIRCOEF01.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HFIRCOEF23.u32));
        V0_HFIRCOEF23.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
        V0_HFIRCOEF23.bits.coef2 = hfir_coef->coef2;
        V0_HFIRCOEF23.bits.coef3 = hfir_coef->coef3;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HFIRCOEF23.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HFIRCOEF45.u32));
        V0_HFIRCOEF45.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
        V0_HFIRCOEF45.bits.coef4 = hfir_coef->coef4;
        V0_HFIRCOEF45.bits.coef5 = hfir_coef->coef5;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HFIRCOEF45.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HFIRCOEF67.u32));
        V0_HFIRCOEF67.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
        V0_HFIRCOEF67.bits.coef6 = hfir_coef->coef6;
        V0_HFIRCOEF67.bits.coef7 = hfir_coef->coef7;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HFIRCOEF67.u32);
    }
...
hi_bool hal_layer_enable_layer(hal_disp_layer layer, hi_u32 enable)
{
    ...
    switch (layer) {
        case HAL_DISP_LAYER_VHD0: {
            ...
            V0_CTRL.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
        ...
        case HAL_DISP_LAYER_GFX0: {
            ...
            G0_CTRL.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
...
hi_bool hal_disp_set_dither_round_unlim(hal_disp_outputchannel chan, hi_u32 dither_round_unlim)
{
    ...
    switch (chan) {
        case HAL_DISP_CHANNEL_DHD0: {
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_CTRL.u32));
...
hi_bool hal_disp_set_dither_sed(hal_disp_outputchannel chan, hal_disp_dihter_sed *dither_sed)
{
    ...
    switch (chan) {
        case HAL_DISP_CHANNEL_DHD0: {
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_Y0.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_U0.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_V0.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_W0.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_Y1.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_U1.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_V1.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_W1.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_Y2.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_U2.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_V2.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_W2.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_Y3.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_U3.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_V3.u32));
            ...
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_SED_W3.u32));
...
hi_bool hal_disp_set_dither_thr_min_max(hal_disp_outputchannel chan, hi_u32 thr_min, hi_u32 thr_max)
{
    ...
    switch (chan) {
        case HAL_DISP_CHANNEL_DHD0: {
            addr_reg = vo_get_chn_abs_addr(chan, (hi_ulong) & (g_vo_reg->INTF0_DITHER_THR.u32));
...
hi_bool hal_video_set_layer_alpha(hal_disp_layer layer, hi_u32 arange)
{
    ...
    switch (layer) {
        case HAL_DISP_LAYER_VHD0: {
            addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_ALPHA.u32));
            V0_ALPHA.u32 = hal_read_reg((hi_u32 *)(hi_ulong) addr_reg);
            V0_ALPHA.bits.vbk_alpha = arange;
            hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_ALPHA.u32);
            break;
        }
...
hi_void hal_layer_csc_set_dc_coef(hal_disp_layer layer, vdp_csc_dc_coef *csc_dc_coef)
{
    ...
    if ((layer >= LAYER_VHD_START) && (layer <= LAYER_VHD_END)) {
        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_IDC0.u32));
        V0_HIPP_CSC_IDC0.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_IDC0.bits.hipp_csc_idc0 = csc_dc_coef->csc_in_dc0;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_IDC0.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_IDC1.u32));
        V0_HIPP_CSC_IDC1.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_IDC1.bits.hipp_csc_idc1 = csc_dc_coef->csc_in_dc1;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_IDC1.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_IDC2.u32));
        V0_HIPP_CSC_IDC2.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_IDC2.bits.hipp_csc_idc2 = csc_dc_coef->csc_in_dc2;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_IDC2.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_ODC0.u32));
        V0_HIPP_CSC_ODC0.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_ODC0.bits.hipp_csc_odc0 = csc_dc_coef->csc_out_dc0;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_ODC0.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_ODC1.u32));
        V0_HIPP_CSC_ODC1.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_ODC1.bits.hipp_csc_odc1 = csc_dc_coef->csc_out_dc1;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_ODC1.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_ODC2.u32));
        V0_HIPP_CSC_ODC2.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_ODC2.bits.hipp_csc_odc2 = csc_dc_coef->csc_out_dc2;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_ODC2.u32);
    }
}
    ...
    if (layer == HAL_DISP_LAYER_GFX0) {
        switch (csc_mode) {
            case HAL_CSC_MODE_RGB_TO_BT601_PC: {
                addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->G0_HIPP_CSC_CTRL.u32));
                V0_HIPP_CSC_CTRL.u32 = hal_read_reg((hi_u32 *)addr_reg);
                V0_HIPP_CSC_CTRL.bits.hipp_csc_mode = 0x0;
                hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_CTRL.u32);
                break;
            }
...
hi_void hal_layer_csc_set_param(hal_disp_layer layer, csc_coef_param *coef_param)
{
    ...
    if ((layer >= LAYER_VHD_START) && (layer <= LAYER_VHD_END)) {
        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_SCALE.u32));
        V0_HIPP_CSC_SCALE.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_SCALE.bits.hipp_csc_scale = coef_param->csc_scale2p;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_SCALE.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_MIN_Y.u32));
        V0_HIPP_CSC_MIN_Y.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_MIN_Y.bits.hipp_csc_min_y = coef_param->csc_clip_min;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_MIN_Y.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_MIN_C.u32));
        V0_HIPP_CSC_MIN_C.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_MIN_C.bits.hipp_csc_min_c = coef_param->csc_clip_min;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_MIN_C.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_MAX_Y.u32));
        V0_HIPP_CSC_MAX_Y.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_MAX_Y.bits.hipp_csc_max_y = coef_param->csc_clip_max;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_MAX_Y.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_MAX_C.u32));
        V0_HIPP_CSC_MAX_C.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_MAX_C.bits.hipp_csc_max_c = coef_param->csc_clip_max;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_MAX_C.u32);
    }
}
...
hi_void hal_layer_csc_set_coef(hal_disp_layer layer, vdp_csc_coef *csc_coef)
{
    ...
    if ((layer >= LAYER_VHD_START) && (layer <= LAYER_VHD_END)) {
        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_COEF00.u32));
        V0_HIPP_CSC_COEF00.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_COEF00.bits.hipp_csc_coef00 = csc_coef->csc_coef00;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_COEF00.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_COEF01.u32));
        V0_HIPP_CSC_COEF01.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_COEF01.bits.hipp_csc_coef01 = csc_coef->csc_coef01;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_COEF01.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_COEF02.u32));
        V0_HIPP_CSC_COEF02.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_COEF02.bits.hipp_csc_coef02 = csc_coef->csc_coef02;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_COEF02.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_COEF10.u32));
        V0_HIPP_CSC_COEF10.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_COEF10.bits.hipp_csc_coef10 = csc_coef->csc_coef10;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_COEF10.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_COEF11.u32));
        V0_HIPP_CSC_COEF11.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_COEF11.bits.hipp_csc_coef11 = csc_coef->csc_coef11;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_COEF11.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_COEF12.u32));
        V0_HIPP_CSC_COEF12.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_COEF12.bits.hipp_csc_coef12 = csc_coef->csc_coef12;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_COEF12.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_COEF20.u32));
        V0_HIPP_CSC_COEF20.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_COEF20.bits.hipp_csc_coef20 = csc_coef->csc_coef20;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_COEF20.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_COEF21.u32));
        V0_HIPP_CSC_COEF21.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_COEF21.bits.hipp_csc_coef21 = csc_coef->csc_coef21;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_COEF21.u32);

        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_COEF22.u32));
        V0_HIPP_CSC_COEF22.u32 = hal_read_reg((hi_u32 *)addr_reg);
        V0_HIPP_CSC_COEF22.bits.hipp_csc_coef22 = csc_coef->csc_coef22;
        hal_write_reg ((hi_u32 *)(hi_ulong) addr_reg, V0_HIPP_CSC_COEF22.u32);
    }
...
hi_void hal_layer_csc_set_ck_gt_en(hal_disp_layer layer, hi_bool ck_gt_en)
{
    ...
    if ((layer >= LAYER_VHD_START) && (layer <= LAYER_VHD_END)) {
        addr_reg = vo_get_abs_addr(layer, (hi_ulong) & (g_vo_reg->V0_HIPP_CSC_CTRL.u32));
        V0_HIPP_CSC_CTRL.u32 = hal_read_reg((hi_u32 *)addr_reg);
