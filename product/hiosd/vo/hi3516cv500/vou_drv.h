...
typedef struct {
    ...
    // hi_hdr scene
    vhdr_scene_mode vhdr_scene_mode;
} vo_hihdr_v_cfg;
...
/***********************************************************************
*  Begin :   WBC Layer Dither config data structures.
***********************************************************************/
typedef enum {
...
hi_void vo_drv_wirte_reg(HI_U64 u64Addr, hi_u32 u32Value);
hi_void vo_drv_read_reg(HI_U64 u64Addr, hi_u32 *pu32Value);
...
hi_void vo_drv_date_setting(vo_hal_dev VoDev, vo_intf_sync enOutSync);
