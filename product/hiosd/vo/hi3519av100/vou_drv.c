...
hi_void vo_drv_set_uhd_clk(vo_hal_dev vo_dev, vo_intf_sync intf_sync)
{
    ...
    switch (intf_sync) {
        ...
        case VO_OUTPUT_1920x1200_60: {
            ...
            postdiv1 = 3;
            postdiv2 = 2;
            vdp_hd_clk_sel = 0x1;  // 0x1 for FHD@120=<sync<=4k60
        ...
        case VO_OUTPUT_2560x1440_30: {
            ...
            postdiv1 = 5;
            postdiv2 = 2;
            vdp_hd_clk_sel = 0x2;  // 0x2 for sync<=FHD@60
            break;
        }
...
hi_s32 vo_drv_set_csc_coef(hal_disp_layer layer, vo_csc *csc, csc_coef_param *csc_coef_param)
{
    csc_coef csc_coef;
    ...
    hal_layer_set_csc_coef(layer, &csc_coef);
