...
typedef struct {
    ...
    volatile unsigned int RESERVED7[38]; /* 0x168~0x1fc */
    volatile U_QUANT_TABLE QUANT_TABLE[64]; /* 0x200~0x2fc */
    volatile U_HDC_TABLE HDC_TABLE[12]; /* 0x300~0x32c */
    volatile unsigned int RESERVED8[4]; /* 0x330~0x33c */
    volatile U_HAC_MIN_TABLE HAC_MIN_TABLE[8]; /* 0x340~0x35c */
    volatile U_HAC_BASE_TABLE HAC_BASE_TABLE[8]; /* 0x360~0x37c */
    volatile unsigned int RESERVED9[32]; /* 0x380~0x3fc */
    volatile unsigned int HAC_SYMBOL_TABLE[176]; /* 0x400~0x6c0 */
} S_JPGD_REGS_TYPE;

// Declare the struct pointor of the module JPEGD
