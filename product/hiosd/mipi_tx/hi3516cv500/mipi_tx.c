...
combo_dev_cfg_t g_mipi_tx_720x576_50_config = {
    .devno = 0,
    .lane_id = { 0, 1, 2, 3 },
...
combo_dev_cfg_t g_mipi_tx_1280x720_60_config = {
    .devno = 0,
    .lane_id = { 0, 1, 2, 3 },
    .output_mode = OUTPUT_MODE_DSI_VIDEO,
    .output_format = OUT_FORMAT_RGB_24_BIT,
...
combo_dev_cfg_t g_mipi_tx_1920x1080_60_config = {
    .devno = 0,
    .lane_id = { 0, 1, 2, 3 },
    .output_mode = OUTPUT_MODE_DSI_VIDEO,
    .output_format = OUT_FORMAT_RGB_24_BIT,
...
combo_dev_cfg_t g_mipi_tx_1024x768_60_config = {
    .devno = 0,
    .lane_id = { 0, 1, 2, 3 },
    .output_mode = OUTPUT_MODE_DSI_VIDEO,
    .output_format = OUT_FORMAT_RGB_24_BIT,
...
combo_dev_cfg_t g_mipi_tx_1280x1024_60_config = {
    .devno = 0,
    .lane_id = { 0, 1, 2, 3 },
    .output_mode = OUTPUT_MODE_DSI_VIDEO,
    .output_format = OUT_FORMAT_RGB_24_BIT,
...
/* ok */
combo_dev_cfg_t g_mipi_tx_720x1280_60_config = {
    .devno = 0,
    .lane_id = { 0, 1, 2, 3 },
    .output_mode = OUTPUT_MODE_DSI_VIDEO,
    .output_format = OUT_FORMAT_RGB_24_BIT,
...
/* ok */
combo_dev_cfg_t g_mipi_tx_1080x1920_60_config = {
    .devno = 0,
    .lane_id = { 0, 1, 2, 3 },
    .output_mode = OUTPUT_MODE_DSI_VIDEO,
    .output_format = OUT_FORMAT_RGB_24_BIT,
